<template>
  <main
    class="grid min-h-screen grid-cols-1 gap-4 p-5 lg:grid-cols-[minmax(280px,380px)_1fr]"
    :class="isDark ? 'bg-[#14181d] text-[#e8edf2]' : 'bg-[#f8f8f6] text-[#2f2a25]'"
  >
    <section
      class="rounded-2xl border p-4"
      :class="isDark ? 'border-[#3a424c] bg-[#1d232b]' : 'border-[#d7ccbf] bg-white'"
    >
      ...
      <label class="mb-4 grid gap-1.5">
        ...
        <input
          ...
          :class="isDark ? 'border-[#4f5967] bg-[#131820]' : 'border-[#cdbfae] bg-white'"
    ...
    <section
      class="flex flex-col justify-center rounded-2xl border p-4"
      :class="isDark ? 'border-[#3a424c] bg-[#1d232b]' : 'border-[#d7ccbf] bg-white'"
      ref="previewHostRef"
    >
      <div
      ...
      <p class="mt-3 text-sm" :class="isDark ? 'text-[#a9b3bf]' : 'text-[#6c5f52]'" v-if="image">
        Drag inside text box to move, drag bottom-right diagonal button to resize.
      </p>
      <p class="mt-3 text-sm" :class="isDark ? 'text-[#a9b3bf]' : 'text-[#6c5f52]'" v-else>
